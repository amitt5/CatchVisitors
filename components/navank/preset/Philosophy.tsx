...
export function Philosophy({ config }: { config: PresetConfig }) {
  ...
  return (
    <section
      ...
      style={{ background: config.sectionAltBg, padding: '10rem 2rem' }}
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: `radial-gradient(ellipse 60% 50% at 50% 50%, ${config.accentMuted} 0%, transparent 70%)`,
        }}
      />
